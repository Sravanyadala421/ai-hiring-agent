...
class GeminiProvider:
    ...
    def chat(
        ...
        **kwargs
        ...
        """Send a chat request to Google Gemini API with timeout."""
        import google.generativeai as genai
        ...
        try:
            # Send the chat request with timeout
            ...
            if "timeout" in error_msg.lower():
                raise TimeoutError("Gemini API request timed out after 60 seconds. Please try again.")
